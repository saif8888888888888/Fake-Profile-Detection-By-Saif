document.addEventListener('DOMContentLoaded', function() {
    ...
    // In the simulateAuthApiCall function, add admin flag for specific users
if ((action === 'login' || action === 'signup') && data.email && data.password) {
    resolve({
        ...
        // Add admin flag for specific email addresses
        isAdmin: data.email === 'admin@example.com' || data.email === 'hsaifullasaif'
    });
} else {
